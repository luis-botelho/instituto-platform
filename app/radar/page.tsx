...
export const metadata: Metadata = { title: 'Radar Mambucaba', description: 'Pesquisa guiada em fontes públicas oficiais sobre contratos, obras, serviços e políticas públicas.', alternates: { canonical: '/radar' } }
